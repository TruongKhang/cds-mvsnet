...
# code to reproduce the evaluations of depth precision
...
if __name__ == '__main__':
    root_dir = "/home/khangtg/Documents/lab/cds-mvsnet/est_depths"
    ...
    for i, depth_folder in enumerate(["depth_stage1", "depth_stage2", "depth_stage3", "depth_est"]): #depth_folder in enumerate(["depth_est"]): #['384_512', '576_832', '832_1152', '960_1280', '1088_1408']: #, '1152_1536']:
        folder = "ours_final_dtu_outputs"
        input_folder = "{}/{}".format(root_dir, folder)
        ...
        max_h, max_w = 1152 // (2**(3 - i)), 1536 // (2**(3 - i)) #in_folder.split('_')
        metrics = casmvsnet_eval.eval(max_h=int(max_h), max_w=int(max_w))
        # print('AUSE of CasMVSNet: %f' % ause)
        print(input_folder, depth_folder, metrics)
